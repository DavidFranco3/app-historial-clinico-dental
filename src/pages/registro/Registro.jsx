        ...
        },
        {
          ...
          table: {
            ...
            body: [
              ...
              [
                {
                  text: `Nombre:  ${formData.nombrePaciente}`,
                  fontSize: 9,
                  bold: true,
                  colSpan: 2
                },
              ...
              [
                {
                  text: `Edad:  ${formData.edadPaciente}`,
                  fontSize: 9,
                  bold: true,
                  colSpan: 1
                },
                {
                  text: `Fecha de nacimiento:  ${formData.fechaNacimientoPaciente}`,
                  fontSize: 9,
                  bold: true,
                  colSpan: 2
                },
                {},
                {
                  text: `No. Tel: ${formData.telefonoPaciente}`,
                  fontSize: 9,
                  bold: true,
                  colSpan: 1
                }
              ...
              [
                {
                  text: `Sexo:  ${formData.sexoPaciente}`,
                  fontSize: 9,
                  bold: true,
                },
                {
                ...
                {
                  text: `email: ${formData.emailPaciente}`,
                  fontSize: 9,
                  bold: true,
                  colSpan: 2,
                },
        ...
        },
        {
          ...
          table: {
            ...
            body: [
              ...
              [
                {
                  text: `Motivo de consulta:  ${formData.motivoConsulta}`,
                  colSpan: 2,
                  bold: true,
                  fontSize: 9,
                  rowSpan: 2,
                ...
                {},
                {
                  text: `Padecimiento actual:  ${formData.padecimientoActual}`,
                  colSpan: 2,
                  fontSize: 9,
                  bold: true,
                  rowSpan: 2
              ...
              [
                {
                  text: `Padecimientos sistémicos:  ${formData.padecimientosSistemticos}`,
                  colSpan: 3,
                  fontSize: 9,
                  bold: true,
                  rowSpan: 2,
                ...
                {},
                {
                  text: `Medicamentos: ${formData.tomandoMedicamento}`,
                  fontSize: 9,
                  bold: true,
                  rowSpan: 2
                },
              ...
              [
                {
                  ...
                  colSpan: 2,
                  stack: [
                    {text: `Diabetes: ${formData.estadoDiabetes}`, bold: true},
                    {text: `${formData.descripcionDiabetes}`}
                  ]
                },{},
                {
                  fontSize: 9,
                  colSpan: 2,
                  stack: [
                    {text: `Hipertensión: ${formData.estadoHipertension}`, bold: true},
                    {text: `${formData.descripcionHipertension}`}
                  ]
                }
              ],
              [
                {
                  ...
                  colSpan: 2,
                  stack: [
                    {text: `Nefropatías: ${formData.estadoDiabetes}`, bold: true},
                    {text: `${formData.descripcionDiabetes}`}
                  ]
                },{},
                {
                  ...
                  colSpan: 2,
                  stack: [
                    {text: `Tuberculosis: ${formData.estadoHipertension}`, bold: true},
                    {text: `${formData.descripcionHipertension}`}
                  ]
                },
                {}
              ...
              [
                {
                  ...
                  colSpan: 2,
                  stack: [
                    {text: `Cáncer: ${formData.estadoCancer}`, bold: true},
                    {text: `${formData.descripcionCancer}`}
                  ]
                },{},
                {
                  fontSize: 9,
                  colSpan: 2,
                  stack: [
                    {text: `Cardiopatías: ${formData.estadoCardiopatias}`, bold: true},
                    {text: `${formData.descripcionCardiopatias}`}
                  ]
                },{},
              ],
              [
                {
                  ...
                  colSpan: 2,
                  stack: [
                    {text: `Alergias: ${formData.estadoAlergias}`, bold: true},
                    {text: `${formData.descripcionAlergias}`}
                  ]
                },{},
                {
                  fontSize: 9,
                  colSpan: 2,
                  stack: [
                    {text: `Otros: ${formData.estadoOtros}`, bold: true},
                    {text: `${formData.descripcionOtros}`}
                  ]
                },{},
              ]
            ],
              ...
              [
                {
                  ...
                  colSpan: 2,
                  stack: [
                    {text: `Diabetes: ${formData.estadoDiabetesAntecedentes}`, bold: true},
                    {text: `${formData.descripcionDiabetesAntecedentes}`}
                  ]
                },{},
                {
                  fontSize: 9,
                  colSpan: 2,
                  stack: [
                    {text: `Hipertensión: ${formData.estadoHipertensionAntecedentes}`, bold: true},
                    {text: `${formData.descripcionHipertensionAntecedentes}`}
                  ]
                }
              ],
              [
                {
                  ...
                  colSpan: 2,
                  stack: [
                    {text: `Nefropatías: ${formData.estadoDiabetesAntecedentes}`, bold: true},
                    {text: `${formData.descripcionDiabetesAntecedentes}`}
                  ]
                },{},
                {
                  ...
                  colSpan: 2,
                  stack: [
                    {text: `Tuberculosis: ${formData.estadoHipertensionAntecedentes}`, bold: true},
                    {text: `${formData.descripcionHipertensionAntecedentes}`}
                  ]
                },
                {}
              ...
              [
                {
                  ...
                  colSpan: 2,
                  stack: [
                    {text: `Cáncer: ${formData.estadoCancerAntecedentes}`, bold: true},
                    {text: `${formData.descripcionCancerAntecedentes}`}
                  ]
                },{},
                {
                  fontSize: 9,
                  colSpan: 2,
                  stack: [
                    {text: `Cardiopatías: ${formData.estadoCardiopatiasAntecedentes}`, bold: true},
                    {text: `${formData.descripcionCardiopatiasAntecedentes}`}
                  ]
                },{},
              ],
              [
                {
                  ...
                  colSpan: 2,
                  stack: [
                    {text: `Alergias: ${formData.estadoAlergiasAntecedentes}`, bold: true},
                    {text: `${formData.descripcionAlergiasAntecedentes}`}
                  ]
                },{},
                {
                  fontSize: 9,
                  colSpan: 2,
                  stack: [
                    {text: `Toxicomanías: ${formData.estadoToxicomaniasAntecedentes}`, bold: true},
                    {text: `${formData.descripcionToxicomaniasAntecedentes}`}
                  ]
                },{},
              ],
              [
                {
                  ...
                  colSpan: 2,
                  stack: [
                    {text: `Sanguineo: ${formData.estadoSanguineoAntecedentes}`, bold: true},
                    {text: `${formData.descripcionSanguineoAntecedentes}`}
                  ]
                },{},
                {
                  fontSize: 9,
                  colSpan: 2,
                  stack: [
                    {text: `Hemorragias: ${formData.estadoHemorragiasAntecedentes}`, bold: true},
                    {text: `${formData.descripcionHemorragiasAntecedentes}`}
                  ]
                },{},
              ]
            ],
          ...
          table: {
            ...
            body: [
              ...
              [
                {
                  fontSize: 9,
                  text: `Alimentación: ${formData.alimentacionAntipatologias}`
                },
                {
                  fontSize: 9,
                ...
                {
                  fontSize: 9,
                  text: `Convivencia con animales: ${formData.convivenciaConAnimalesAntipatologias}`
                }
              ],
              [
                {
              ...
              [
                {
                  columns: [
                    ...
                    },
                    {
                      fontSize: 9,
                      bold: true,
                      text: `Peso: ${formData.pesoSignosVitales}`,
                      border: [true, true, true, false]
                    }
                  ],
                }
                  ...
                  columns: [
                    {
                      fontSize: 9,
                      bold: true,
                      text: `Talla: ${formData.tallaSignosVitales}`,
        ...
        },
        {
          ...
          table: {
            ...
            body: [
              ...
              [
                {
                  text: `Estudios de gabinete: ${formData.descripcionEstudiosGabinete}`,
                  fontSize: 9,
                  bold: true,
                },
                {
                  text: `Estudios de laboratorio: ${formData.descripcionEstudiosLaboratorio}`,
                  fontSize: 9,
                  bold: true,
                }
              ]
          ...
          table: {
            ...
            body: [
              ...
              [
                ...
                {
                  fontSize: 9,
                  text: `Tejido óseo: ${formData.tejidoOseoCavidadBucal}`,
                  bold: true,
                }
              ],
              [
                {
                  fontSize: 9,
                  stack: [
                    {text: `Dolor: ${formData.estadoDolor}`, bold: true},
                    {text: `${formData.descripcionDolor}`}
                  ]
                },
                {
                  fontSize: 9,
                  stack: [
                    {text: `Crepitación: ${formData.estadoCrepitacion}`, bold: true},
                    {text: `${formData.descripcionCrepitacion}`}
                  ]
                },
              ],
              [
                {
                  fontSize: 9,
                  stack: [
                    {text: `Subluxación: ${formData.estadosubluxacion}`, bold: true},
                    {text: `${formData.descripcionsubluxacion}`}
                  ]
                },
                {
                  fontSize: 9,
                  stack: [
                    {text: `Anquilosis: ${formData.estadoAnquilosis}`, bold: true},
                    {text: `${formData.descripcionAnquilosis}`}
                  ]
                },
              ],
              [
                {
                  fontSize: 9,
                  stack: [
                    {text: `Bruxismo: ${formData.estadoBruxismo}`, bold: true},
                    {text: `${formData.descripcionBruxismo}`}
                  ]
                },
                {
                  fontSize: 9,
                  stack: [
                    {text: `Espasmo muscular: ${formData.estadoEspasmoMuscular}`, bold: true},
                    {text: `${formData.descripcionEspasmoMuscular}`}
                  ]
                },
              ],
              [
                {
                  fontSize: 9,
                  stack: [
                    {text: `Luxación: ${formData.estadoLuxacion}`, bold: true},
                    {text: `${formData.estadoLuxacion}`}
                  ]
                },
                {
                  fontSize: 9,
                  text: `Diagnóstico: ${formData.diagnostico}`,
                  bold: true,
                },
              ],
              [
                {
                  fontSize: 9,
                  text: `Pronóstico: ${formData.pronostico}`,
                  bold: true,
                },
                {
                  fontSize: 9,
